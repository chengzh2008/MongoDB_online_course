...
public class BlogPostDAO {
    ...
    public String addPost(String title, String body, List tags, String username) {
        ...
        post.append("title", title).append("body", body).append("tags", tags)
                .append("author", username).append("permalink", permalink)
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        postsCollection.update(new BasicDBObject("_id", post.get("_id")),
                new BasicDBObject("$set", new BasicDBObject("comments", comments)));
